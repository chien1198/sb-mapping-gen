...
Nguồn: docx section "4.1.3 Bảng DIM_LOS_COLLATERAL"

| STT | Tên cột | Kiểu dữ liệu | Bắt buộc | Độ lớn | Khóa | Mô tả |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | DIMENSION_KEY | NUMBER | Y | 18 | PK | Khóa chính của bảng chiều DIM_LOS_COLLATERAL, sinh bằng Oracle sequence |
...
| 20 | COLLATERAL_TYPE_SK | NUMBER | Y | 18 |  | Khóa tham chiếu đến bảng chiều DIM_LOS_COLLATERAL_TYPE. Giá trị mặc định = -1 nếu không có giá trị phù hợp |
