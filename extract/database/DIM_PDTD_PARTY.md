...
Nguồn: docx section "4.3.3 Bảng DIM_PDTD_PARTY"

| STT | Tên cột | Kiểu dữ liệu | Bắt buộc | Độ lớn | Khóa | Mô tả |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | DIMENSION_KEY | NUMBER | Y | 18 | PK | Khóa chính của bảng chiều DIM_PDTD_PARTY, giữ nguyên DIMENSION_KEY của bảng chiều tương ứng bên DWH_LOS, không sinh sequence mới |
...
| 18 | CURR_FULL_ADDRESS | VARCHAR2 | N | 1000 |  | Địa chỉ hiện tại đầy đủ |
| 19 | GEO_SK | NUMBER | Y | 18 |  | Khóa tham chiếu đến bảng chiều DIM_PDTD_GEO. Giá trị mặc định = -1 nếu không có giá trị phù hợp |
| 20 | EFF_DATE | DATE | Y |  |  | Ngày bắt đầu hiệu lực của bản ghi |
| 21 | EXP_DATE | DATE | N |  |  | Ngày hết hiệu lực của bản ghi |
