...
Nguồn: docx section "4.2.4 Bảng FCT_LOS_COLLATERAL"
...
| 4 | COLLATERAL_SK | NUMBER | Y | 18 |  | Khóa tham chiếu đến bảng chiều DIM_LOS_COLLATERAL. Giá trị mặc định = -1 nếu không có giá trị phù hợp |
...
| 6 | COLLATERAL_TYPE_SK | NUMBER | Y | 18 |  | Khóa tham chiếu đến bảng chiều DIM_LOS_COLLATERAL_TYPE. Giá trị mặc định = -1 nếu không có giá trị phù hợp |
